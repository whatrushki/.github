...
![React.js](https://img.shields.io/badge/React.js-09090b?style=for-the-badge&logo=react&logoColor=white)
![Web](https://img.shields.io/badge/Web_Frontend-09090b?style=for-the-badge&logo=html5&logoColor=white)
...
- **Кроссплатформенная разработка:** Мобильные и десктопные приложения на Kotlin и Compose Multiplatform.
- **Бэкенд и автоматизация:** Сервисы, боты и инструменты обработки данных на Python и Kotlin.
- **Веб-разработка:** Интерактивные веб-интерфейсы и клиентские приложения на JavaScript / Web стандартах.
- **Инфраструктура:** Контейнеризация сервисов в Docker и администрирование Linux-серверов.

---

<div align="center">
<sub>© WHAT Technologies.</sub>
</div>